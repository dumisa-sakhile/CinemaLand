...
const MovieCard = ({
  ...
  return (
    <Link to={`/movie/${id}`}>
      <motion.article
        className="bg-[#27272a] border border-[rgb(16,16,43)] relative w-[178px] min-h-[393px] text-center  rounded-md  roboto-condensed-regular hover:animate-pulse "
        ...
        <div className="w-full h-[124px]  rounded-b-md flex flex-col justify-start items-start p-2 gap-4 pb-4">
          ...
          <aside className=" text-white text-sm p-1 flex gap-2 items-center">
            {`${rating} (${voteCount})`}
            <svg
