...
export default function Home() {
  ...
  return (
    <motion.div
      ...
      <section>
        <div>
          <div className="container flex flex-col items-center justify-center lg:min-h-screen px-4 py-16 pb-24 mx-auto text-center lg:pb-56 md:py-32 md:px-10 lg:px-32 text-gray-50 gap-8 ">
            <motion.h1
