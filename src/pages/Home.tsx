...
export default function Home() {
  ...
  return (
    <>
    <Meta title="Cinema Land | Home" description="Discover new favorites, explore genres, and join a community of film enthusiasts. Your ultimate cinema destination, curated just for you." canonicalUrl="https://cinema-land.vercel.app/"/>
      <motion.div
